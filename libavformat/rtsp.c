...
const AVOption ff_rtsp_options[] = {
    ...
    { "refplayer_rtsp_lower_transport", "current negotiated RefPlayer RTSP lower transport", OFFSET(lower_transport), AV_OPT_TYPE_INT, {.i64 = RTSP_LOWER_TRANSPORT_UDP}, 0, RTSP_LOWER_TRANSPORT_UDP_MULTICAST, DEC | AV_OPT_FLAG_EXPORT | AV_OPT_FLAG_READONLY },
